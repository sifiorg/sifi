...
import ParticleSprite from 'src/assets/space-travel/particle-sprite.png';
import Noise from 'src/assets/space-travel/noise.jpg';
...
export default class StarfieldMaterial extends ShaderMaterial {
  ...
  constructor(context: SpaceTravelContext, parameters: StarfieldMaterialParameters = {}) {
    const {
      ...
      particleTextureUrl = ParticleSprite,
      noiseTextureUrl = Noise,
    } = parameters;
