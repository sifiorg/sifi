...
contract WarpLinkMainnet17853419Test is WarpLinkTestBase, CurveHelpers {
  ...
  function testFork_warpLinkEngage_Unwrap() public {
    bytes memory commands = abi.encodePacked(
      (uint8)(1), // Command count
    ...
    vm.prank(user);
    Mainnet.WETH.approve(address(diamond), 2 ether);
  ...
  function testFork_warpLinkEngagePermit_Unwrap() public {
    bytes memory commands = abi.encodePacked(
      (uint8)(1), // Command count
      (uint8)(COMMAND_TYPE_UNWRAP)
    );
  ...
  function testFork_warpLinkEngage_swapSingleUniV2Sushi() public {
  ...
  function testFork_warpLinkEngagePermit_swapSingleUniV2Sushi() public {
    IAllowanceTransfer.PermitDetails memory details = IAllowanceTransfer.PermitDetails({
      token: address(Mainnet.WETH),
      amount: 1 ether,
      expiration: deadline,
  ...
  function testFork_warpLinkEngage_wrapAndSwapSingleUniV2Sushi() public {
  ...
  function testFork_warpLinkEngage_wrapAndSwapSingleUniV2Chained() public {
  ...
  function testFork_warpLinkEngage_splitWrap() public {
    // Split into 3 wraps
    bytes memory commands = abi.encodePacked(
      (uint8)(1), // Command count
  ...
  function testFork_warpLinkEngage_wrapSplitSwap() public {
  ...
  function testFork_warpLinkEngage_wrapSplitSwapNested() public {
  ...
  function testFork_warpLinkEngage_univ2LikeMulti() public {
  ...
  function testFork_warpLinkEngagePermit_univ2LikeMulti() public {
    IAllowanceTransfer.PermitDetails memory details = IAllowanceTransfer.PermitDetails({
  ...
  function testFork_warpLinkEngagePermit_positiveSlippage() public {
    IAllowanceTransfer.PermitDetails memory details = IAllowanceTransfer.PermitDetails({
      token: address(Mainnet.WETH),
      amount: 1 ether,
      expiration: deadline,
  ...
  function testFork_warpLinkEngagePermit_collectFee() public {
    IAllowanceTransfer.PermitDetails memory details = IAllowanceTransfer.PermitDetails({
      token: address(Mainnet.WETH),
      amount: 1 ether,
      expiration: deadline,
  ...
  function testFork_warpLinkEngage_deadline() public {
    bytes memory commands = abi.encodePacked(
  ...
  function testFork_warpLinkEngagePermit_swapSingleUniV3() public {
    IAllowanceTransfer.PermitDetails memory details = IAllowanceTransfer.PermitDetails({
      token: address(Mainnet.USDC),
      amount: 1000 * (10 ** 6),
      expiration: deadline,
  ...
  function testFork_warpLinkEngage_univ3LikeMulti() public {
  ...
  function testFork_warpLinkEngagePermit_univ3LikeMulti() public {
    IAllowanceTransfer.PermitDetails memory details = IAllowanceTransfer.PermitDetails({
      token: address(Mainnet.USDC),
      amount: 1000 * (10 ** 6),
      expiration: deadline,
  ...
  function testFork_warpLinkEngage_warpCurve_EthToSteth() public {
    bytes memory commands = abi.encodePacked(
      (uint8)(1), // Command count
  ...
  function testFork_warpLinkEngage_warpCurve_StethToEth() public {
    bytes memory commands = abi.encodePacked(
      (uint8)(1), // Command count
      (uint8)(COMMAND_TYPE_WARP_CURVE_EXACT_INPUT_SINGLE),
      (address)(0), // tokenOut
    ...
    vm.prank(user);
    SafeERC20.forceApprove(Mainnet.STETH, address(diamond), 2 ether);
  ...
  function testFork_warpLinkEngagePermit_warpCurve_StethToEth() public {
    IAllowanceTransfer.PermitDetails memory details = IAllowanceTransfer.PermitDetails({
  ...
  function testFork_warpLinkEngagePermit_warpCurveDaiToGusd() public {
  ...
  function testFork_warpLinkEngagePermit_warpCurveV2Twice() public {
  ...
  function testFork_warpLinkEngage_warpCurveV1AndFactory() public {
    deal(user, 1 ether);
   ...
   */
  function testFork_warpLinkEngagePermit_warpCurveTricryptoOptimizedWETH_useEthOut() public {
    uint8 kind = 3;
   ...
   */
  function testFork_warpLinkEngagePermit_warpCurveTricryptoOptimizedWETH_dontUseEthOut() public {
    uint8 kind = 3;
    address pool = 0x7F86Bf177Dd4F3494b841a37e810A34dD56c829B;
    uint256 amountIn = 0.01 * (10 ** 8);
